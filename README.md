...
| 8.	As a parent, I want the app to have a child-lock feature that prevents my children from making unintended changes to the robot's tasks or schedule. | RT5000 app will include a child-lock feature that can be enabled or disabled by the parent. | ---- |
